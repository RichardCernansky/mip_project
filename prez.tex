...
\title{Application of vector algebra and physics in designing steering behaviours of autonomous agents for realistic display in two dimensions 
}
...
\begin{frame}[fragile=singleslide]\frametitle{Nový slide s obrazkom}
	\begin{itemize}
		\item obrazok
		\includegraphics[scale= 0.4]{75-750271_car-top-view-png-audi-transparent-png.png}
		
		\item daľšia odrážka
	\end{itemize}
		\end{frame}

\begin{frame}[fragile=singleslide]\frametitle{Nový slide}
	\begin{itemize}
		\item odrážka
		\begin{itemize}
			\item prvý subitem
